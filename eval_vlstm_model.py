...
if __name__ == "__main__":
    ...
    model_name = "LSTM_Model_Simple"
    history_path = "History_LSTM_Model_Simple_20201203"
    cc06pv_pairs, cc06pv_tracks, cc06pv_targets, cc06sv_pairs, cc06sv_tracks, cc06sv_targets = np.load("data/numpy/cc/cc_06_pair_pv_pairs.npy"), np.load("data/numpy/cc/cc_06_pair_pv_tracks.npy"), np.load("data/numpy/cc/cc_06_pair_pv_targets.npy"), np.load("data/numpy/cc/cc_06_pair_sv_pairs.npy"), np.load("data/numpy/cc/cc_06_pair_sv_tracks.npy"), np.load("data/numpy/cc/cc_06_pair_sv_targets.npy")
    bb07pv_pairs, bb07pv_tracks, bb07pv_targets, bb07sv_pairs, bb07sv_tracks, bb07sv_targets = np.load("data/numpy/bb/bb_07_pair_pv_pairs.npy"), np.load("data/numpy/bb/bb_07_pair_pv_tracks.npy"), np.load("data/numpy/bb/bb_07_pair_pv_targets.npy"), np.load("data/numpy/bb/bb_07_pair_sv_pairs.npy"), np.load("data/numpy/bb/bb_07_pair_sv_tracks.npy"), np.load("data/numpy/bb/bb_07_pair_sv_targets.npy")
    ...
    plt.legend()
    plt.grid()
    plt.savefig("data/figure/loss/Accuracy_" + model_name + ".pdf")
    plt.clf()
    ...
    predict_labels = model.predict([pair, tracks], verbose=1)
