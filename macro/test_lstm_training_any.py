...
if __name__ == "__main__":
    ...
    model_name = "VLSTM_Model_InitState_ZeroPadding_Masking_Shuffle_" \
                 ...
                 + str(nb_epochs) + "epochs_1LSTM_any_pairs"
    
    if pair_reinforce:
        model_name = model_name + "_pair_loss"

    name_track_labels_pv = "/home/goto/ILC/Deep_Learning/data/vfdnn_03_track_labels_pv.npy"
    name_track_labels_sv = "/home/goto/ILC/Deep_Learning/data/vfdnn_03_track_labels_sv.npy"
    name_track_labels_nc = "/home/goto/ILC/Deep_Learning/data/vfdnn_03_track_labels_nc.npy"
    name_tracks_pvsvnc = "/home/goto/ILC/Deep_Learning/data/vfdnn_03_tracks_pvsvnc.npy"
    name_track_pairs_pv = "/home/goto/ILC/Deep_Learning/data/vfdnn_03_track_pairs_pv.npy"
    name_track_pairs_sv = "/home/goto/ILC/Deep_Learning/data/vfdnn_03_track_pairs_sv.npy"
    name_track_pairs_nc = "/home/goto/ILC/Deep_Learning/data/vfdnn_03_track_pairs_nc.npy"
    name_track_plabels_pv = "/home/goto/ILC/Deep_Learning/data/vfdnn_03_track_plabels_pv.npy"
    name_track_plabels_sv = "/home/goto/ILC/Deep_Learning/data/vfdnn_03_track_plabels_sv.npy"
    name_track_plabels_nc = "/home/goto/ILC/Deep_Learning/data/vfdnn_03_track_plabels_nc.npy"
    ...
    data_track_labels_nc = np.load(name_track_labels_nc, allow_pickle=True)
    data_tracks_pvsvnc = np.load(name_tracks_pvsvnc, allow_pickle=True)
    ...
    data_track_pairs_nc = np.load(name_track_pairs_nc, allow_pickle=True)
    ...
    data_track_plabels_nc = np.load(name_track_plabels_nc, allow_pickle=True)

    lenpv = int(len(data_track_labels_pv)/3)
    lensv = int(len(data_track_labels_sv)/3)
    lennc = int(len(data_track_labels_nc)/3)

    data_track_labels = np.concatenate([data_track_labels_pv[:lenpv], data_track_labels_sv[:lensv], data_track_labels_nc[:lennc]], 0)
    data_tracks = np.concatenate([data_tracks_pvsvnc[:lenpv], data_tracks_pvsvnc[:lensv], data_tracks_pvsvnc[:lennc]], 0)
    data_track_pairs = np.concatenate([data_track_pairs_pv[:lenpv], data_track_pairs_sv[:lensv], data_track_pairs_nc[:lennc]], 0)
    data_track_plabels = np.concatenate([data_track_plabels_pv[:lenpv], data_track_plabels_sv[:lensv], data_track_plabels_nc[:lennc]], 0)
    ...
    model, history = LSTMMODEL.vlstm_model(teach_track_pairs, teach_tracks, targets, 
                                           NB_EPOCHS=nb_epochs, 
