...
def vlstm_model(pair, tracks, labels, NB_EPOCHS, 
                INIT_DENSE=2, INPUT_DIM=22, NODE_SIZE=32, NB_SAMPLES=50000, pair_reinforce=False):
    ...
    x = TimeDistributed(Dense(256, name='Embedding_Dense'))(track_input)

    #init_state1 = Dense(NODE_SIZE)(pair_input)
    #init_state1 = BatchNormalization()(init_state)
    #init_state1 = Activation('relu')(init_state)
    #init_state2 = Dense(NODE_SIZE)(pair_input)
    #init_state2 = BatchNormalization()(init_state)
    #init_state2 = Activation('relu')(init_state)
    #init_state3 = Dense(NODE_SIZE)(pair_input)
    #init_state3 = BatchNormalization()(init_state)
    #init_state3 = Activation('relu')(init_state)
    ...
    for i in range(INIT_DENSE-1):
        dname = 'Dense_' + str(i+2)
        bname = 'BatchNorm_' + str(i+2)
        aname = 'Activation' + str(i+2)
        #init_state1 = Dense(NODE_SIZE)(init_state1)
        #init_state1 = BatchNormalization()(init_state1)
        #init_state1 = Activation('relu')(init_state1)
        #init_state2 = Dense(NODE_SIZE)(init_state2)
        #init_state2 = BatchNormalization()(init_state2)
        #init_state2 = Activation('relu')(init_state2)
        #init_state3 = Dense(NODE_SIZE)(init_state3)
        #init_state3 = BatchNormalization()(init_state3)
        #init_state3 = Activation('relu')(init_state3)
        init_state = Dense(NODE_SIZE, name=dname)(init_state)
        init_state = BatchNormalization(name=bname)(init_state)
        init_state = Activation('relu', name=aname)(init_state)

    #cell1 = CUSTOM.VLSTMCell_M(NODE_SIZE)
    #cell2 = CUSTOM.VLSTMCell_M(NODE_SIZE)
    #cell3 = CUSTOM.VLSTMCell_M(NODE_SIZE)
    cell = CUSTOM.VLSTMCell(NODE_SIZE, 1)

    #x = RNN(cell1, return_sequences=True, name='VLSTM_1',)(x, initial_state=[init_state1, init_state1])
    #x = RNN(cell2, return_sequences=True, name='VLSTM_2',)(x, initial_state=[init_state2, init_state2])
    #x = RNN(cell3, return_sequences=True, name='VLSTM_3',)(x, initial_state=[init_state3, init_state3])
