...
if __name__ == "__main__":
    ...
    model_name = "VLSTM_Model_InitState_ZeroPadding_Masking_Shuffle_" \
                 ...
                 + str(nb_epochs) + "epochs_1LSTM_only_secondary"
    ...
    data_track_labels = np.load(name_track_labels_pv, allow_pickle=True)
    #data_track_labels = np.load(name_track_labels_sv, allow_pickle=True)
    data_tracks = np.load(name_tracks_pvsv, allow_pickle=True)
    data_track_pairs = np.load(name_track_pairs_pv, allow_pickle=True)
    #data_track_pairs = np.load(name_track_pairs_sv, allow_pickle=True)
    data_track_plabels = np.load(name_track_plabels_pv, allow_pickle=True)
