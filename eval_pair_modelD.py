...
if __name__ == "__main__":
    ...
    """
    history_path_first = "History_Pair_Model_Standard_201129_ModelD_loss_weights_vertex0.1_position0.9_1000epochs_20201130"
    history_path_second = "History_Pair_Model_Standard_201129_ModelD_loss_weights_vertex0.1_position0.9_1000epochs_plus_loss_weights_vertex0.9_position0.1_1500epochs_20201203"
    history_path_third = "History_Pair_Model_Standard_201129_ModelD_loss_weights_vertex0.1_position0.9_1000epochs_plus_loss_weights_vertex0.9_position0.1_1500epochs_plus_loss_weights_vertex0.95_position0.05_500epochs_lr_0.0001_20201203"
    ...
    evaltools.EfficiencyCurve(predict_vertex, true_vertex, model_name+"_Others")
